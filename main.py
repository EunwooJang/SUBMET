...
def plot_find_ratio_simulation(iteration_number=100,
    ...
    for point in shift_and_score_ratio:
        x, y, a = point
        ...
        # 노이즈의 유무가 확실치 않음
            ...
            # 노이즈가 확실치 않음 / negative 펄스가 없음 => matching indice 이용
                ...
                if candidate_list:
                    ...
                    """
                    plot_single_array(ratio_list, "Ratio", 1, 1,
                                      ylim=[-0.1, 1.1], mode="line", datatype="else", points=None,
                                      show=1, save=0, path=None)
                    plot_single_array(s_datavolt, 1, 1, 1,
                                      ylim=[0, 3800], mode="line", datatype="else", points=None,
                                      show=1, save=0, path=None)
...
def plot_single_array(array, title, xaxis, yaxis,
                      ylim=None, mode="line", datatype="else", points=None, span=None,
